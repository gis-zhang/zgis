...
LGNModelParser.prototype.parse = function(content){
    if(!content){
        return null;
    }
    ...
    for(var i = 0; i < entities.length; i++){//console.info("i=" + i);if(i === 38){debugger;}
        var curEntity = this.parseEntity(entities[i]);
...
LGNModelParser.prototype.text2dom = function(text){
    var dom = null;
...
LGNModelParser.prototype.getAttributeValue = function(node, name){
...
LGNModelParser.prototype.getNodeName = function(node){
    return node.nodeName;
}

LGNModelParser.prototype.parseNode = function(node){
    if(!node){
        return null;
    }
...
LGNModelParser.prototype.createObjectProperty = function(object, propName, propValue){
    if(propName){
        object[propName] = propValue;
    }
}

LGNModelParser.prototype.parseEntity = function(entityNode){
    if(!entityNode){
        return null;
    }
...
LGNModelParser.prototype.parseStl3DNode = function(stl3DNode, elementType){
...
LGNModelParser.prototype.getElementColor = function(elementType){
    return this.colorSetting[elementType] || 0xaaaa00;
}

LGNModelParser.prototype.getElementOpacity = function(elementType){
    return this.opacitySetting[elementType] || 1;
}

LGNModelParser.prototype.parseRelation = function(relationNode){
...
LGNModelParser.prototype.buildObjectRelation = function(entities, relations){
    var allObjects = {},
        rootObjects = {};
...
LGNModelParser.prototype.findFloors = function(entities){
    var floors = {},
        storeyIndexes = {};;
